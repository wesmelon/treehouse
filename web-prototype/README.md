...
> **Note:** This is the original web-based prototype. For a full-fledged Windows game with more features, see the [StardewClone](../StardewClone/) project!
...
- `mapState.js` — save/load functionality.
- `DESIGN.md` — design notes and implementation details.

## Want More Features?

Check out the **[StardewClone](../StardewClone/)** project for a full-fledged Windows game with:
- Multiple crop types with realistic growth times
- Complex economy and shop system
